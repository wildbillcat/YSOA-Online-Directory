class Submission < ActiveRecord::Base
  ...
  COLLECTIONS = [%q/Design Review: MArch1 2012 to 2013/, %q/Design Review: MArch2 2012 to 2013/, %q/Graduating Review: MArch1 2012 to 2013/, %q/Graduating Review: MArch 2 2012 to 2013/]
